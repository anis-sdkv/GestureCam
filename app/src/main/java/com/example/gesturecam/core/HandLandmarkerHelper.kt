...
class HandLandmarkerHelper(
    var state: LandmakerState = LandmakerState(),
        ...
        try {
            ...
            val optionsBuilder =
                HandLandmarker.HandLandmarkerOptions.builder()
                    ...
                    .setMinHandDetectionConfidence(state.currentMinHandDetectionConfidence)
                    .setMinTrackingConfidence(state.currentMinHandTrackingConfidence)
                    .setMinHandPresenceConfidence(state.currentMinHandPresenceConfidence)
                    .setNumHands(state.currentMaxHands)
